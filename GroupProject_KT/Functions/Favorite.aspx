<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="Favorite.aspx.cs" Inherits="GroupProject_KT.Functions.Favorite" %>
            ...
            <tr style="text-align: center; vertical-align: middle;">
                <td>
                    <div style="position: center">
                        <asp:Label ID="lbtb" runat="server" Text="" ForeColor="YellowGreen"></asp:Label>
                    </div>
                </td>
            </tr>
            <tr>
                            ...
                            <tr style="width: 100%">
                                ...
                                <td>
                                    <h2>
                                        ...
                                        <br />
                                        <asp:Button ID="bt_Remove" runat="server" Text="Remove Favorate" OnClick="bt_Remove_Click" CommandArgument='<%# Eval("MAXE") %>' />
